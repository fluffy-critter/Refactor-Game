return {
  ...
  greg = {
    ...
    crying = {
      {x = 176, y = 40, w = 22, h = 39},
      {x = 176, y = 88, w = 22, h = 39},
      {x = 176, y = 136, w = 22, h = 39},
    },
    down = {
      {x = 0, y = 48, w = 16, h = 39},
      {x = 24, y = 48, w = 16, h = 40},
    ...
    right = {
      {x = 72, y = 96, w = 16, h = 40},
      {x = 96, y = 96, w = 16, h = 40},
      {x = 120, y = 96, w = 16, h = 40},
    },
    sitting = {
      normal = {x = 144, y = 48, w = 24, h = 40},
      thinking = {x = 144, y = 96, w = 24, h = 40},
    },
    up = {
      {x = 72, y = 48, w = 16, h = 39},
      {x = 96, y = 48, w = 16, h = 40},
